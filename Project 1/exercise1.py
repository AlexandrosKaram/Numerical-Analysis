...
def main():
    ...
    print(
        f"\ta. Root: {bisection_results[0][0]} Iterations needed: {bisection_results[0][1]}"
    )
    print(
        f"\tb. Root: {bisection_results[1][0]} Iterations needed: {bisection_results[1][1]}"
    )
    print("2. Newton-Raphson method:")
    print(
        f"\ta. Root: {newton_raphson_results[0][0]} Iterations needed: {newton_raphson_results[0][1]}"
    )
    print(
        f"\tb. Root: {newton_raphson_results[1][0]} Iterations needed: {newton_raphson_results[1][1]}"
    )
    print("3. Secant method:")
    print(
        f"\ta. Root: {secant_method_results[0][0]} Iterations needed: {secant_method_results[0][1]}"
    )
    print(
        f"\tb. Root: {secant_method_results[1][0]} Iterations needed: {secant_method_results[1][1]}"
    )
